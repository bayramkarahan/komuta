...
#include <memory>
#include "../../../e-ag-client-tray/ekran.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Ekran_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Ekran_t qt_meta_stringdata_Ekran = {
    {
QT_MOC_LITERAL(0, 0, 5) // "Ekran"
...
QT_INIT_METAOBJECT const QMetaObject Ekran::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Ekran.data,
    qt_meta_data_Ekran,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Ekran::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ekran.stringdata0))
